    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day_selected:
                    'bg-purple-500 text-zinc-50 hover:bg-purple-500 hover:text-zinc-50 focus:bg-purple-500 focus:text-zinc-50 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50 dark:hover:text-zinc-900 dark:focus:bg-zinc-50 dark:focus:text-zinc-900',
                day_today:
